  ...
  return (
    <div className="bg-black w-full text-white pb-20">
      <div className="mx-auto w-[90%] rounded-3xl bg-[linear-gradient(180deg,#004A7C,#004A7C00)] py-12">
        <h4 className="text-4xl font-extrabold text-center lg:w-1/3 mx-5 lg:mx-auto mb-10">
          Our customer results speak for themselves. Take a look.
        </h4>
        <div className="flex flex-col lg:flex-row gap-20 lg:px-20 px-10">
          <div
            className="lg:w-1/3 p-6 py-4 relative"
            style={{
              backgroundImage:
          ...
          >
            <div className="lg:w-1/5 w-1/4 absolute lg:top-5 lg:left-0 lg:-translate-x-1/3 top-0 -translate-y-1/3 right-6">
