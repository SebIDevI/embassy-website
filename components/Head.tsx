  ...
  return (
    ...
    <section className="h-[100vh] min-h-[700px] lg:block flex items-center justify-center relative lg:pt-10 bg-[#ecf3f8]">
      <div className="flex flex-col-reverse lg:flex-row lg:items-center container">
        <div className="font-extrabold text-2xl w-full text-center lg:text-left lg:text-xl">
          <h1 className="text-5xl sm:text-6xl lg:text-8xl xl:text-8xl text-blueEmb font-pro overflow-hidden">
